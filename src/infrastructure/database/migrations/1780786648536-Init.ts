...
export class Init1780786648536 implements MigrationInterface {
    name = 'Init1780786648536'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."otp_records_status_enum" AS ENUM('PENDING', 'VERIFIED', 'EXPIRED', 'USED')`);
        await queryRunner.query(`CREATE TYPE "public"."otp_records_purpose_enum" AS ENUM('TWO_FACTOR', 'RESET_PASSWORD')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_registrationstage_enum" AS ENUM('OTP_VERIFIED', 'PASSWORD_SET', 'COMPLETED')`);
        ...
        await queryRunner.query(`ALTER TABLE "otp_records" ADD CONSTRAINT "FK_dc4b5901f412028b31b3ff7bb9d" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "otp_records" ADD CONSTRAINT "FK_e3da906c893cc0eb23559274b9c" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "otp_records" DROP CONSTRAINT "FK_e3da906c893cc0eb23559274b9c"`);
        await queryRunner.query(`ALTER TABLE "otp_records" DROP CONSTRAINT "FK_dc4b5901f412028b31b3ff7bb9d"`);
